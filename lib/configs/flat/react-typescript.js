...
// NOTE: eslint-plugin-react / jsx-a11y は ESLint 10 を peerDependencies で宣言しておらず、
// 旧 context API (getFilename 等) を使うため、@eslint/compat でラップして互換性を確保する。
// TODO: 両プラグインが ESLint 10 を peerDependencies で宣言したら fixup を除去する。
module.exports = [
  ...
  },
  {
    ...
    rules: {
      ...
      // SEE: https://github.com/cybozu/eslint-config/blob/master/lib/react.js
      // =======
      // Error
      // =======
